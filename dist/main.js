...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _taskArr_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taskArr.js */ \"./app/modules/taskArr.js\");\n\r\n\r\nfunction deleteInStorage(element) {\r\n  const itemToDelete = element.children[0].children[0].children[1].innerText;\r\n  console.log(_taskArr_js__WEBPACK_IMPORTED_MODULE_0__.tasks);\r\n  const index = _taskArr_js__WEBPACK_IMPORTED_MODULE_0__.tasks.map((task) => task.desc).indexOf(itemToDelete);\r\n  _taskArr_js__WEBPACK_IMPORTED_MODULE_0__.tasks.splice(index, 1);\r\n  let count = 1;\r\n  _taskArr_js__WEBPACK_IMPORTED_MODULE_0__.tasks.forEach((element) => {\r\n    element.id = count;\r\n    count += 1;\r\n  });\r\n  console.log(_taskArr_js__WEBPACK_IMPORTED_MODULE_0__.tasks.length);\r\n\r\n  localStorage.setItem('tasks', JSON.stringify(_taskArr_js__WEBPACK_IMPORTED_MODULE_0__.tasks));\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (deleteInStorage);\r\n\n\n//# sourceURL=webpack://to-do-list/./app/modules/delete_from_localStorage.js?");
